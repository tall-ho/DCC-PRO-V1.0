...
export default function CalendarHub() {
  ...
  const [events, setEvents] = useState([
    { id: 'EV-2603-001', date: '2026-03-02', title: 'Weekly Sales Meeting', time: '09:00', type: 'Internal', priority: 'Normal', status: 'Scheduled', color: 'bg-[#5372ba]/10 text-[#5372ba] border-[#5372ba]/20' },
    { id: 'EV-2603-002', date: '2026-03-05', title: 'Supplier Audit: Thai Steel Co.', time: '10:30', type: 'Audit', priority: 'High', status: 'Confirmed', color: 'bg-[#ce870a]/10 text-[#ce870a] border-[#ce870a]/20' },
    { id: 'EV-2603-003', date: '2026-03-09', title: 'Follow-up SCAR-2603-001', time: '14:00', type: 'Quality', priority: 'Critical', status: 'Scheduled', color: 'bg-[#d96245]/10 text-[#d96245] border-[#d96245]/20' },
    { id: 'EV-2603-004', date: '2026-03-12', title: 'Contract Renewal: ABC Packaging', time: '11:00', type: 'Contract', priority: 'High', status: 'Confirmed', color: 'bg-[#6293b9]/10 text-[#6293b9] border-[#6293b9]/20' },
    { id: 'EV-2603-005', date: '2026-03-15', title: 'VAT Filing Deadline', time: '16:00', type: 'Finance', priority: 'Critical', status: 'Confirmed', color: 'bg-[#b84530]/10 text-[#b84530] border-[#b84530]/20' },
  ]);
  ...
  const handleSaveEvent = (e: any) => {
    ...
    if (modalMode === 'create') setEvents([...events, payload]);
    else setEvents(events.map(ev => ev.id === eventForm.id ? payload : ev));
  ...
  return (
    <div className="flex flex-1 min-h-0 w-full font-sans flex-col pb-0 animate-fadeIn bg-transparent">
      ...
      <button onClick={() => setIsGuideOpen(true)} className="fixed right-0 top-[220px] -translate-y-1/2 bg-white border border-[#eaeaec] border-r-0 text-[#212c46] py-8 px-1.5 rounded-l-xl shadow-md hover:bg-[#d96245] hover:text-white hover:border-[#d96245] transition-all duration-500 z-[100] flex flex-col items-center gap-4 group">
