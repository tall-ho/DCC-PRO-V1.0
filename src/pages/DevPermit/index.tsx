          ...
          <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                  <div className="flex items-center gap-3">
                      <h3 className="font-black text-[#212c46] uppercase tracking-widest text-[24px] flex items-center gap-2 leading-none">DEV <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3f809e] to-[#b58c4f] drop-shadow-sm">PERMIT</span></h3>
